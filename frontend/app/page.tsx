                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="mt-4 font-bold text-white sm:text-lg">{card.title}</p>
                      <p className="mt-2 text-sm text-white/70 sm:mt-3 sm:text-base">{card.description}</p>
                    </div>
                  </Link>
                );
              })}
            ...
            <div className="relative overflow-hidden">
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 md:gap-6 lg:grid-cols-2 xl:grid-cols-3">
                {getVisibleAdvantages().map((adv, index) => (
                  <div
                    key={adv.title}
                    className={`flex min-h-[200px] flex-col gap-5 rounded-[12px] bg-[#090909] p-6 card-hover ${index === 0 ? 'animate-card' : index === 1 ? 'animate-card-delay-1' : index === 2 ? 'animate-card-delay-2' : index === 3 ? 'animate-card-delay-3' : index === 4 ? 'animate-card animate-stagger-4' : 'animate-card animate-stagger-5'
                      }`}
                  >
          ...
          <div className="mt-6 grid gap-4 px-4 sm:mt-8 sm:gap-6 md:grid-cols-2 md:px-6 lg:grid-cols-3 lg:px-8">
            {getVisibleTestimonials().map((testimonial, index) => (
              <div
                ...
                className={`flex w-full flex-col gap-3 rounded-xl border border-white/10 bg-[#090909] p-4 sm:gap-4 sm:rounded-2xl sm:p-5 md:p-6 card-hover ${index === 0 ? 'animate-card' : index === 1 ? 'animate-card-delay-1' : 'animate-card-delay-2'
                  }`}
              >
              ...
              {getVisibleNews().map((news, index) => {
                ...
                return (
                  <div
                    ...
                    className={`flex w-full flex-col gap-3 rounded-xl bg-[#090909] p-4 sm:gap-4 sm:rounded-2xl sm:p-5 md:flex-row card-hover ${index === 0 ? 'animate-card' : 'animate-card-delay-1'
                      }`}
                  >

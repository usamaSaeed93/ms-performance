          ...
          <main className="space-y-12">
            ...
            <section className="relative overflow-hidden bg-[#030814] text-white h-[360px]">
              ...
              <div className="relative h-full flex items-center px-8 lg:px-12">
                <h1 className="text-5xl font-black lg:text-6xl">Cart</h1>
              </div>
            </section>
            ...
            <section className="px-8 py-10 lg:px-12">
              <div className="grid gap-8 lg:grid-cols-[2fr_1fr]">
                ...
                <div className="space-y-4">
                  <h2 className="text-2xl font-bold text-[#0c1b33] mb-6">Cart</h2>
                  {items.length === 0 ? (
                    <div className="bg-white rounded-[16px] border border-gray-200 p-8 text-center">
                      <p className="text-[#5c6c86]">Your cart is empty</p>
                      <Link href="/products" className="mt-4 inline-block text-[#1d70ff] hover:underline">
                        Continue Shopping
                      </Link>
                    </div>
                  ) : (
                    items.map((item) => (
                      <div
                        key={item.id}
                        className="bg-white rounded-[16px] border border-gray-200 p-6 flex gap-4"
                      >
                        {/* Product Image */}
                        <div className="relative w-24 h-24 flex-shrink-0 rounded-[8px] overflow-hidden bg-gray-100">
                          <Image
                            src={item.image}
                            alt={item.name}
                            width={96}
                        ...
                        <div className="flex-1 flex items-center justify-between">
                          <div className="flex-1">
                            <h3 className="text-lg font-semibold text-[#0c1b33] mb-2">{item.name}</h3>
                            <p className="text-xl font-bold text-[#0c1b33]">£{item.price}</p>
                          </div>
                          ...
                          <div className="flex items-center gap-3">
                            <button
                              ...
                              className="flex h-8 w-8 items-center justify-center rounded-[8px] border border-gray-300 bg-white hover:bg-gray-50 transition"
                            >
                              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" className="text-[#0c1b33]">
                          ...
                          <button
                            ...
                            className="ml-4 flex h-10 w-10 items-center justify-center rounded-[8px] text-red-500 hover:bg-red-50 transition"
                          >
                ...
                <div className="lg:sticky lg:top-8 h-fit">
                  <div className="bg-white rounded-[16px] border border-gray-200 p-6 space-y-6">
                    <h2 className="text-2xl font-bold text-[#0c1b33]">Order Summary</h2>
                    ...
                    <div className="space-y-2">
                      <div className="flex gap-2">
                        ...
                        <button className="rounded-[8px] bg-[#1d70ff] px-6 py-3 text-sm font-semibold text-white hover:bg-[#1a5fdd] transition">
                          Apply
                        </button>
                      </div>
                    </div>
                    ...
                    <Link
                      href="/checkout"
                      className="block w-full rounded-[12px] bg-[#1d70ff] px-6 py-4 text-center text-base font-semibold text-white hover:bg-[#1a5fdd] transition"
                    >
                      Go to Checkout →
                    </Link>
                  </div>

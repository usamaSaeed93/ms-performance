                ...
                <div className="space-y-4 sm:space-y-5 md:space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-4 gap-3">
                      {["PayPal", "Visa", "Mastercard", "Maestro", "Apple Pay", "Google Pay", "Stripe", "American Express"].map((payment, idx) => (
                        <div
                          key={payment}
                          className="flex h-16 items-center justify-center rounded-[8px] border border-gray-200 bg-white px-3 text-xs font-semibold text-[#5c6c86]"
                        >
                          {payment}
                        </div>
                      ))}

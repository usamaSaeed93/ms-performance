...
//             {/* Hero Section */}
//             <section className="relative overflow-hidden bg-[#030814] text-white h-[200px]">
//               <Image
...
//                   {/* Product Title */}
//                   <h1 className="text-3xl font-black text-[#0c1b33] lg:text-4xl">{product.title}</h1>

//                   {/* Pricing */}
//                   <div className="flex items-baseline gap-3">
//                     {product.oldPrice && (
//                       <span className="text-xl text-[#9aa6bd] line-through">{product.oldPrice}</span>
//                     )}
//                     <span className="text-4xl font-black text-[#0c1b33]">{product.price}</span>
//                   </div>

//                   {/* Sales & Rating */}
//                   <div className="flex items-center gap-4">
//                     <span className="text-sm text-[#5c6c86]">{product.sold || 1238} Sold</span>
...
//                         })}
//                       </div>
//                       <span className="text-sm text-[#5c6c86] ml-1">{product.rating}</span>
//                     </div>
//                   </div>
...
//                       {["PayPal", "Visa", "Mastercard", "American Express", "Apple Pay", "Google Pay", "Stripe"].map((payment) => (
//                         <div
//                           key={payment}
//                           className="flex h-10 items-center justify-center rounded-[8px] border border-gray-200 bg-white px-3 text-xs font-semibold text-[#5c6c86]"
//                         >
//                           {payment}
//                         </div>
//                       ))}
...
//                     <button className="rounded-[12px] bg-[#1d70ff] px-6 py-4 text-base font-semibold text-white hover:bg-[#1a5fdd] transition">
//                       Add To Cart
//                     </button>

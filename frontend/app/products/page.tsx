              ...
              <div className="flex flex-col items-start justify-between gap-4 mb-4 sm:mb-6 sm:flex-row sm:items-center">
                ...
                <div className="flex flex-wrap items-center gap-4">
                  <span className="text-sm text-[#5c6c86]">
                    Showing {startIndex}-{endIndex} of {displayTotal} Products
                  </span>
                  <select
                      ...
                      <PopoverTrigger asChild>
                        <div className="relative">
                          <input
                            ...
                            className="rounded-[8px] border border-gray-300 bg-white px-4 py-2 pl-10 pr-10 text-sm text-[#0c1b33] placeholder:text-gray-400 focus:border-[#1d70ff] focus:outline-none"
                          />
                          <svg
                            width="16"
                            height="16"

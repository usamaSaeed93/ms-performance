                ...
                <nav className="flex flex-1 flex-wrap items-center justify-end gap-6 text-sm font-semibold">
                  {navLinks.map((link) => (
                    <Link
                      key={link.label}
                      href={link.href}
                      className={`relative pb-1 transition hover:text-[#1d70ff] ${link.href === "/products" ? "text-[#1d70ff]" : "text-white/80"
                        }`}
                    >
                      {link.label}
                      {link.href === "/products" && (
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-4 gap-3">
                      {[
                        ...
                        <div
                          key={payment.name}
                          className={`flex h-16 items-center justify-center rounded-[8px] bg-white p-2 shadow-sm hover:shadow-md transition card-hover ${idx === 0 ? 'animate-card' : idx === 1 ? 'animate-card-delay-1' : idx === 2 ? 'animate-card-delay-2' : 'animate-card-delay-3'
                            }`}
                        >
                          <Image
                            src={payment.logo}

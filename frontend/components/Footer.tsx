            ...
            <div className="grid gap-8 lg:grid-cols-[2fr_1fr_1.5fr_1.5fr_1fr]">
                ...
                <div className="space-y-4 pt-2">
                    ...
                    <div className="space-y-3">
                        ...
                        <a href="https://www.facebook.com/msperformanceltd" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm text-[#5c6c86] transition hover:text-[#00b8ff] group">
                            <div className="rounded-full bg-[#00b8ff] p-1 text-white group-hover:bg-[#00b8ff]/80">
                        ...
                        <a href="https://www.tiktok.com/@msperformanceltd" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm text-[#5c6c86] transition hover:text-[#00b8ff] group">
                            <div className="rounded-full bg-[#00b8ff] p-1 text-white group-hover:bg-[#00b8ff]/80">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
